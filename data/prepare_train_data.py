...
parser.add_argument("--dataset_dir", type=str, default="./data/CS_RAW", help="where the dataset is stored")
parser.add_argument("--dataset_name", type=str, default="cityscapes", choices=["kitti_raw_eigen", "kitti_raw_stereo", "kitti_odom", "cityscapes"])
parser.add_argument("--dump_root", type=str, default="./data/CS", help="Where to dump the data")
